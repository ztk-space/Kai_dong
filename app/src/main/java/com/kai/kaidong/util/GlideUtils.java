...
public class GlideUtils {
    public static void load(Object object, ImageView imageView) {
        ...
        load(object, imageView, R.mipmap.ic_launcher);
    }
    ...
    public static void loadBlurry(ImageView imageView, Object o) {
        ...
        if (drawable == null) {
            drawable = ContextCompat.getDrawable(imageView.getContext(), R.mipmap.ic_launcher);
        }
        if (!Utils.isNetworkConnected(imageView.getContext())) {
            o = ContextCompat.getDrawable(imageView.getContext(), R.mipmap.ic_launcher);
        }
