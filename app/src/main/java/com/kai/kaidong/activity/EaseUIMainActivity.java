...
import com.kai.kaidong.uifragment.Constant;
import com.kai.kaidong.uifragment.ConversationFragment;
import com.kai.kaidong.uifragment.PersonFragment;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class EaseUIMainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ease_uimain);
        ...
        contactFragment.setContactListItemClickListener(new EaseContactListFragment.EaseContactListItemClickListener() {
            ...
            public void onListItemClicked(EaseUser user) {
                startActivity(new Intent(EaseUIMainActivity.this, ECChatActivity.class).putExtra(EaseConstant.EXTRA_USER_ID, user.getUsername()));
            }
        });
